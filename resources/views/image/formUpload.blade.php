            ...
            <div class="card">
                ...
                <div class="card-body card-body-up">
                    ...
                    <form method="POST" action="{{ route('image.upload') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">{{ __('Descripcion') }}</label>

                            <div class="col-md-6">
                                <textarea id="content" type="text" class="form-control @error('content') is-invalid @enderror" name="content"  required autocomplete="content"></textarea>
