...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- Form for the configuration of the auth user. -->
            @if(session('message'))
            ...
            <div class="card card-config">
                <div class="card-header">{{ __('Configuracion de la cuenta') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description"  required autocomplete="description">{{ Auth::user()->description }}</textarea>
