...
@foreach($followers as $follow)<!-- I receive the relation from the table of followers, it is a column which has an id which has a relation with the user who is  a follower of the auth user -->
<div class="container">
    <?php
    $user = $follow->getUser($follow->follower);/* I get the user who is follower of the auth user. I get him/her by the user_id which i have in the table of followers */
